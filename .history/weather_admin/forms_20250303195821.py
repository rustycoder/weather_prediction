...
class SignUpForm(UserCreationForm):
	...
	def __init__(self, *args, **kwargs):
		...
		self.fields['password1'].help_text = '<ul class="form-text text-muted small"><li><small class="text-white">Your password can\'t be too similar to your other personal information.</small></li><li><small class="text-white">Your password must contain at least 8 characters.</small></li><li class="text-white">Your password can\'t be a commonly used password.</li><li class="text-white">Your password can\'t be entirely numeric.</li></ul>'
